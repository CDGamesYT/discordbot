...
subtitle: function(data) {
	const measurements = ['Miliseconds', 'Seconds', 'Minutes', 'Hours', 'Days', 'Weeks', 'Months (30 Days)', 'Years (365 Days)', '(Time)s/m/h/d'];
	...
	short_description: "Wait mod with more functions edited by Costin Dale!",
...
<p>
Created By : GamingPlusPlus#9050 edited by CostinDale#5572
</p>
	<div style="float: left; width: 45%;">
		...
		<select id="measurement" class="round">
			...
			<option value="8">(Time)s/m/h/d  (Write the parameter)</option>
		</select>
	</div>
